...
import { Mail, Lock, Eye, EyeOff, ArrowRight, Sparkles, Heart, Star, Briefcase } from 'lucide-react'
            ...
            <div className="relative bg-white backdrop-blur-2xl rounded-3xl shadow-2xl border border-white overflow-hidden">
              ...
              <div className="relative bg-white rounded-3xl p-8">
                ...
                >
                  ...
                  <p className="text-base text-gray-600">Sign in to your recruiter account</p>
                </motion.div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-500">
                      Contact your agency administrator for account access
                    </p>
                  </motion.div>
                ...
                {/* Bottom Section - Are you an agency? */}
                <motion.div
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 1 }}
