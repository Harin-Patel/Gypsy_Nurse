...
const FULL_DESCRIPTIONS: Record<string, string> = {
  ...
  'labor-and-delivery-nurse': 'Labor and delivery nurses not only care for patients but also educate new mothers. These specialized nurses assist during childbirth, monitor maternal and fetal well-being, provide emotional support, and help new families navigate the birthing process with expertise and compassion.',
